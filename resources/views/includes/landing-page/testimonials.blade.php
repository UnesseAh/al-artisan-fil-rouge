<section class="mt-5 mb-5" style="outline: 2px solid red">
            ...
            <div id="carouselBasicExample" class="carousel slide carousel-dark" data-mdb-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="mt-5 mb-4">
                            <img src="{{ asset('image/artisan-2.jpg') }}"
                                 class="rounded-circle img-fluid shadow-1-strong" alt="smaple image" width="100"
                                 height="100" />
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="mt-5 mb-4">
                            <img src="{{ asset('image/artisan-3.jpg') }}"
                                 class="rounded-circle img-fluid shadow-1-strong" alt="smaple image" width="100"
                                 height="100" />
                        </div>
